...
class PollsTest(LiveServerTestCase):
	...
	def setUp(self):
		...
		self.browser = webdriver.Chrome('/Volumes/MacBook/projects/python/clinicaMeiTan/selenium/webdriver/chrome/chromedriver')
	...
	def test_can_create_new_poll_via_admin_site(self):
		...
		self.assertIn(u"Administração do Django\nUsuário:\nSenha:\n ", body.text)

		# She types in her username and passwords and hits return
		username_field = self.browser.find_element_by_name('username')
		username_field.send_keys('teste123')

		password_field = self.browser.find_element_by_name('password')
		password_field.send_keys('teste12345')
		...
		new_poll_link = self.browser.find_element_by_link_text('Adicionar poll')
		new_poll_link.click()
		...
		save_button = self.browser.find_element_by_css_selector("input[value='Salvar']")
		save_button.click()
